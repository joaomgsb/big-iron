          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-neutral-600 mt-1">
                Plataforma Big Iron - Última atualização: 15 de junho de 2025 - Versão: 2.0
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-8">
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              ...
              <ul className="space-y-2 text-gray-700 ml-4">
                <li>• <strong>Nome:</strong> Big Iron</li>
                <li>• <strong>URL:</strong> https://biofittnes.netlify.app</li>
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-3">
                O acesso, cadastro e utilização da plataforma Big Iron, seja através do website ou aplicativo móvel, implica na aceitação integral, expressa e irrevogável destes Termos de Uso e Política de Privacidade.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <p><strong className="text-blue-800">Plataforma:</strong> <span className="text-blue-700">Conjunto de serviços digitais oferecidos através do website e aplicativo Big Iron</span></p>
                </div>
          ...
          <section className="mb-8">
            ...
            <div className="mb-6">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">A plataforma Big Iron oferece:</p>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700">
              <p><strong>7.1 Direitos Autorais:</strong> Todo conteúdo original é protegido por direitos autorais. Receitas certificadas são propriedade intelectual da nutricionista responsável. Design e desenvolvimento pertencem à plataforma Big Iron.</p>
            ...
            <div className="bg-gradient-to-r from-primary-50 to-blue-50 border-2 border-primary-200 rounded-lg p-6">
              ...
              <div className="bg-white rounded-lg p-4 mb-4">
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4">
                  ...
                  <p className="text-yellow-700">
                    Ao criar conta, acessar ou utilizar a plataforma Big Iron, o usuário declara expressamente que:
                  </p>
                </div>
              ...
              <div className="text-center text-gray-600 space-y-2">
                ...
                <div className="text-center text-gray-500 text-sm mt-4">
                  <p>© 2025 Big Iron - Todos os direitos reservados</p>
