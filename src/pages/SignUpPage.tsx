...
import { Mail, Lock, User, AlertCircle, Key, Activity, Calculator, Heart } from 'lucide-react';
...
const SignUpPage: React.FC = () => {
  ...
  const validateStep1 = () => {
    return codeValidated && name && email && password && confirmPassword && password === confirmPassword;
  };
